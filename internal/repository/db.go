...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.dropAllUsersStmt, err = db.PrepareContext(ctx, dropAllUsers); err != nil {
		return nil, fmt.Errorf("error preparing query DropAllUsers: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.dropAllUsersStmt != nil {
		if cerr := q.dropAllUsersStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing dropAllUsersStmt: %w", cerr)
		}
	}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		dropAllUsersStmt:      q.dropAllUsersStmt,
